...
public class CurrencyConverterWithSessionTracking extends JFrame {
    ...
    private final double[] ratesToUsd = {
        0.0, // Placeholder for "Select a currency"
    ...
    public CurrencyConverterWithSessionTracking(String name) {
        ...
        setSize(500, 350);
        setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE); // so we can confirm exit
        ...
        addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e) {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    System.exit(0); // only exit if confirmed
                }
            }
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            String name = JOptionPane.showInputDialog(null, "Welcome! Please enter your name:");
            if (name != null && !name.trim().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Welcome, " + name + "!");
                new CurrencyConverterWithSessionTracking(name.trim());
            }
        });
    }
}
